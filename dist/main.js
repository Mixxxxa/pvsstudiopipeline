...
//     export class PlogConverterResult {
//     };
//     export class PlogConverter {
//     };
//     /**
//      * Special class to easy extend analyzer output
//      */
...
//       }
//       static async generateAnalysisTask(): Promise<CppAnalyzerTask> {
...
//       //   return args;
//       // }
//       public async run(task: PVSStudio.Analyzer.CppAnalyzerTask): Promise<PVSStudio.Analyzer.CppAnalyzerRunResult> {
...
//       analyzer.install();
//     }
//     const task = await PVSStudio.Analyzer.CppAnalyzer.generateAnalysisTask();
//     const analysisResult = await analyzer.run(task);
//     core.setOutput('raw-report', analysisResult.rawReport);
//     if (task.shouldBeConverted()) {
//       const plogConverter = new PVSStudio.Analyzer.PlogConverter();
//     }
...
// //   return args
// // }
// // async function runAnalyzer(): Promise<PVSStudio.Analyzer.CppAnalyzerRunResult> {
